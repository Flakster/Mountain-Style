...
RSpec.describe Vote, type: :model do
  ...
  context 'vote methods' do
    ...
    it 'chooses the most popular article based on the amount of votes' do
      vote1 = Vote.create(user_id: user1.id, article_id: article1.id)
      vote2 = Vote.create(user_id: user1.id, article_id: article2.id)
      vote3 = Vote.create(user_id: user2.id, article_id: article2.id)
